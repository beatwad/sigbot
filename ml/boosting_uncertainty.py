...
def virtual_ensemble_predict(model: LGBMClassifier, X: np.ndarray, k: int = 20) -> np.ndarray:
    """
...
def predict_with_uncertainty(model: LGBMClassifier, X: np.ndarray, k: int = 20) -> PredictionDict:
