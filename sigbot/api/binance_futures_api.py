...
cryptocurrency exchange API. It defines the `BinanceFutures` class, which
...
class BinanceFutures(ApiBase):
    ...
    def delete_duplicate_symbols(symbols: pd.Series) -> List[str]:
        """
        Remove duplicate symbols where pairs with USDT exist and
        delete the corresponding BUSD pairs.
