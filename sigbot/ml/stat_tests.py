"""
Теперь нужно выяснить распределение остатков, для 
этого проведем несколько тестов:
1. Тест Шапиро-Вилкса на нормальность
2. Тест для одной выборки на несмещенность
3. Тест на гомоскедастичность
"""
