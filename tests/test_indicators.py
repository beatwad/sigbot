...
@pytest.mark.parametrize('df, ticker, timeframe, expected',
                         [
                          (df_btc_5m, 'BTC', '5m', [[0.2608, 0.169, 0.236, -0.44762, 0.34343,
                                                    -0.5287, 0.55779, -0.66101, 0.6836],
                                                    [0.0028, -0.0793, -0.0144, -0.44762, 0.34343,
                                                     -0.5287, 0.55779, -0.66101, 0.6836],
                                                    [-0.0959, -0.0799, 0.0639, -0.44762, 0.34343,
                                                     -0.5287, 0.55779, -0.66101, 0.6836]]),
                          (df_eth_5m, 'ETH', '5m', [[0.0049, 0.0191, -0.1887, -0.63315, 0.71829,
                                                    -0.79934, 1.11272, -0.99277, 1.37686],
                                                    [-0.2987, 0.2201, 0.2561, -0.63315, 0.71829,
                                                     -0.79934, 1.11272, -0.99277, 1.37686],
                                                    [-0.0927, -0.3034, -0.3124, -0.63315, 0.71829,
                                                     -0.79934, 1.11272, -0.99277, 1.37686]]),
                          ], ids=repr)
